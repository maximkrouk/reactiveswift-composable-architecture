...
/// your application may model a counter in an _Identifiable fashion:
///
///     struct CounterState: _Identifiable {
///       let id: UUID
///       var count = 0
///     }
...
///
///     struct AppState { var counters = _IdentifiedArray<Int>(id: \.self) }
...
///       }
///     }
public struct _IdentifiedArray<ID, Element>: MutableCollection, RandomAccessCollection
where ID: Hashable {
...
extension _IdentifiedArray: CustomDebugStringConvertible {
...
extension _IdentifiedArray: Decodable where Element: Decodable & _Identifiable, ID == Element.ID {
...
extension _IdentifiedArray: Encodable where Element: Encodable {
...
extension _IdentifiedArray where Element: Comparable {
...
extension _IdentifiedArray: ExpressibleByArrayLiteral
where Element: _Identifiable, ID == Element.ID {
...
extension _IdentifiedArray where Element: _Identifiable, ID == Element.ID {
...
extension _IdentifiedArray: RangeReplaceableCollection
where Element: _Identifiable, ID == Element.ID {
  public init() {
    self.init([], id: \.id)
  }
...
/// A convenience type to specify an `_IdentifiedArray` by an _Identifiable element.

public typealias _IdentifiedArrayOf<Element> = _IdentifiedArray<Element.ID, Element>
where Element: _Identifiable
